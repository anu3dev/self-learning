...
df = pandas.read_csv("009-python-machine-learning/helper/data.csv")
X = df[['Weight', 'Volume']]
y = df['CO2']
...
print(predictedCO2)
# We have predicted that a car with 1.3 liter engine, and a weight of 2300 kg, will release approximately 
