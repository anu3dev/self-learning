...
class ProducerConsumerProblemEx1 {
	public ProducerConsumerProblemEx1() {
		/*
		 * 
		 * in this example, no inter-thread communication is happening means,
		 * producer is producing randomly and if consumer is getting time then it is consuming randomly.
		 * 
		 */
		Queue q = new Queue();
...
class ProducerConsumerProblemEx2 {
	public ProducerConsumerProblemEx2() {
		/*
		 * 
		 * in this example inter-thread communication is happening means
...
public class P07ThreadsProducerAndConsumerProblem {
	public static void main(String[] args) {
		//new ProducerConsumerProblemEx1();
		
		//new ProducerConsumerProblemEx2();
	}
}
