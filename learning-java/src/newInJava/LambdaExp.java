/*
 * types of interface:
 * 1. Normal interface - interface those are not below two means interface which are neither SAM nor Marker.
 * 
 * 2. SAM interface - single abstract method interface ex. cloneable
 * cloleanable or runnable are interface examples which has only one methods.
 * SAM is also called functional or Lambda.
 * 
 * 3. Marker interface - which has zero methods. ex. serialization
 * using Serializable keyword we can ask JVM to store the current state of program.
 * 
 * in Lambda, compiler doesn't create .class file seprately, it uses the existing .class file
...
public class LambdaExp {
	public static void main(String[] args) {
		...
		/*
		 * calling interface using anynomous method
		 */
		...
		/*
		 * if single statement then no need to write curly brances
		 */
