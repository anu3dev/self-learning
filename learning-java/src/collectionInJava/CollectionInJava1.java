...
class CollectionArrayListEx1 {
	public CollectionArrayListEx1 () {
...
class CollectionArrayListEx2 {
	public CollectionArrayListEx2() {
...
class CollectionArrayListEx3 {
	public CollectionArrayListEx3() {
...
public class CollectionInJava1 {
	public static void main(String[] args) {
		...
		//new CollectionArrayListEx1();
		
		System.out.println("1******************");
		
		//new CollectionArrayListEx2();
		
		System.out.println("1******************");
		
		new CollectionArrayListEx3();
	}
}
